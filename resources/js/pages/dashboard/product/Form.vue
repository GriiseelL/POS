    ...
    const formSchema = Yup.object().shape({
        ...
        stock: props.selected
            ? Yup.string() // Skip validasi jika edit
            : Yup.string().required("Stok harus diisi"),
    });
    ...
    function getEdit() {
        ...
        ApiService.get("product/product", props.selected)
            .then(({ data }) => {
                ...
                product.value.price = formatPriceInput(data.product.price.toString());
    ...
    function submit() {
        ...
        formData.append("price", product.value.price.replace(/\./g, ""));
