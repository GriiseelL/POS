...
const routes: Array<RouteRecordRaw> = [
    {
        ...
        children: [
            ...
            //PRODUCT
            {
                ...
                name: "dashboard.product.items",
                component: () => import("@/pages/dashboard/product/index.vue"),
                meta: {
                    pageTitle: "Website product",
                    breadcrumbs: ["Website", "Product", "Items"],
                },
            },
            {
                ...
                component: () =>
                    import("@/pages/dashboard/product/category/index.vue"),
                meta: {
                    pageTitle: "Website Category",
...

            {
                ...
                component: () =>
                    import("@/pages/dashboard/transaction/index.vue"),
                meta: {
                    pageTitle: "Website Transaction",
            ...
            },
            {
                ...
                name: "dashboard.sale",
                component: () =>
                    import("@/pages/dashboard/sale/index.vue"),
                meta: {
                    pageTitle: "Website sale",
                    breadcrumbs: ["Website", "sale"],
                },
            },
